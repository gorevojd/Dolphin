...
#ifndef SPLIT_INTO_SCANLINES
INTERNAL_FUNCTION void RenderGroupToOutput(render_group* RenderGroup, loaded_bitmap* OutputTarget, gdRect2i ClipRect){
#else
INTERNAL_FUNCTION void RenderGroupToOutput(render_group* RenderGroup, loaded_bitmap* OutputTarget, gdRect2i ClipRect, bool Even){
#endif
